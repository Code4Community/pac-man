...
import ghostFunc from "./modules/ghostFunc.js";
import directFunc from "./modules/directFunc.js";
import worldFunc from "./modules/worldFunc.js"
...
function create() {
    ...
    worldLayer = map.createLayer('Tile Layer 1', tileset);
